...
#define GETTEXT_PACKAGE "libgphoto2_port-12"
...
#define IOLIB_LIST "disk ptpip serial usb1 usbdiskdirect usbscsi"
...
#define PACKAGE_STRING "libgphoto2 port access library 0.12.0"
